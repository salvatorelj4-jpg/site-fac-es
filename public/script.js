...
async function excluirItem(id) { if(confirm("Excluir item?")) { await fetch(`/api/itens/${id}`, { method: 'DELETE', headers: { 'Authorization': localStorage.getItem('stalker_token') } }); location.reload(); } }
